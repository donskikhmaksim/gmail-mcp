 ...
 * gmail_confirm_upload (mutates nothing — a status probe whose destination is
 * pinned to a Google upload session URI by `assertGoogleUploadUrl`).
 *
...
const SIDE_EFFECT_MARKERS = [
  ...
  ["own store write", /\b(?:addSnooze|addScheduledSend|cancelScheduledSend)\s*\(/],
];
